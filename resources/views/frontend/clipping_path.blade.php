...
@section ('page-title', 'Clipping Path Cut Out | Ecommerce Product Editing Services')
@push ('page-css')
<style type="text/css">
</style>
@endpush
...
<section class="mobile-common-page">
    <div class="container py-col-2 py-sm-3 py-md-4 py-lg-5 py-xl-5">
        <div class="head pt-col-1 pt-sm-2 pt-md-2 pt-lg-3 pt-xl-3">
            <h1 class="pb-col-2 pb-sm-3 pb-md-4 pb-lg-5 pb-xl-5 mobile-pb-10 text-center">Clipping Path Service</h1>
            <div class="box" style="box-shadow: 0 20px 80px -20px rgba(0,0,0,0.38);">
                <img src="{{asset('assets/frontend/img/Service_All/Clipping_Path_Service/Clipping_Path_Service.png')}}"
                    alt="Clipping_Path_Service" class="img-fluid" loading="lazy" style="width: 100%;">
...
<section class="mobile-pb-20">
    <div class="container pt-col-2 pt-sm-3 pt-md-4 pt-lg-5 pt-xl-5">
        ...
        <div class="box my-col-2 my-sm-3 my-md-4 my-lg-5 my-xl-5"
            ...
            <img src="{{asset('assets/frontend/img/Service_All/Clipping_Path_Service/Clipping_Path_Sample.png')}}" alt="Clipping_Path_Sample" loading="lazy"
...
<section>
    <div class="container pb-col-2 pb-sm-3 pb-md-4 pb-lg-5 pb-xl-5">
        <div class="head mobile-pb-10">
            <h2 class="text-center text-capitalize">Clipping Path To Load Ecommerce Product on Stores with Transparent and Pure White Background</h2>
        </div>
        <div class="design_body pb-col-2 pb-sm-3 pb-md-4 pb-lg-5 pb-xl-5">
            <div class="single pt-col-2 pt-sm-3 pt-md-4 pt-lg-5 pt-xl-5">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <img src="{{asset('assets/frontend/img/Service_All/Clipping_Path_Service/Clipping_Path_1.png')}}" alt="clipping-path"
                            class="img-fluid" loading="lazy" style="width: 100%;">
                    </div>
                </div>
            </div>
            <div class="single pt-col-2 pt-sm-3 pt-md-4 pt-lg-5 pt-xl-5 mobile-pt-20">
                <div class="row pt-sm-4 pt-xs-3">
                    ...
                    <div class="col-md-6">
                        <img src="{{asset('assets/frontend/img/Service_All/Clipping_Path_Service/Clipping_Path_2.png')}}" alt="clipping-path"
                            class="img-fluid" loading="lazy" style="width: 100%;">
                    </div>
                </div>
            </div>
            <div class="single pt-col-2 pt-sm-3 pt-md-4 pt-lg-5 pt-xl-5 mobile-pt-20">
                <div class="row pt-sm-4 pt-xs-3">
                    ...
                    <div class="col-md-6">
                        <img src="{{asset('assets/frontend/img/Service_All/Clipping_Path_Service/Clipping_Path_3.png')}}" alt="clipping-path"
                            class="img-fluid" loading="lazy" style="width: 100%;">
                    </div>
                </div>
            </div>
