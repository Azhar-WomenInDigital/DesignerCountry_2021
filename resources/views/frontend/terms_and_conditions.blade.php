...
@section ('paeg-title', 'Designer Country Terms-and-Conditions | Photo Editing Services')
@push ('paeg-css')
<style type="text/css">
</style>
@endpush
@section ('page-content')
  ...
  <section class="mobile-common-page">
    <div class="container py-col-2 py-sm-3 py-md-4 py-lg-5 py-xl-5 px-2 mobile-pt-20">
      <div>
        ...
        <div class="py-col-2 py-sm-3 py-md-4 py-lg-5 py-xl-5 mt-col-2 mt-sm-5 mobile-pt-20">
          <h6 class="mobile-pt-20">Last updated Jan 01, 2020.</h6>
          <h6 class="pt-2">Welcome to Designer Country</h6>
        </div>
      </div>
      <div>
        <h2 class="pb-2 mobile-pt-20">1. Introduction</h2>
        <p>A debt of gratitude to you for picking Designer Country. By going to, utilizing our site
          ...
          at <a href="{{route('index')}}" rel="preload">https://designercountry.com</a> You recognize that you have perused and comprehended the Agreements,
        ...
        <h2 class="pb-2 pt-col-2 pt-sm-3 pt-md-4 pt-lg-5 pt-xl-5 mobile-pt-20">2. Changes to the Agreements</h2>
        ...
        <h2 class="pb-2 pt-col-2 pt-sm-3 pt-md-4 pt-lg-5 pt-xl-5 mobile-pt-20">3. Site Limitations and Modifications</h2>
        ...
        <h2 class="pb-2 pt-col-2 pt-sm-3 pt-md-4 pt-lg-5 pt-xl-5 mobile-pt-20">4. Using the Site</h2>
        ...
        <h2 class="pb-2 pt-col-2 pt-sm-3 pt-md-4 pt-lg-5 pt-xl-5 mobile-pt-20">5. Rights We Grant to You</h2>
        ...
        <h2 class="pb-2 pt-col-2 pt-sm-3 pt-md-4 pt-lg-5 pt-xl-5 mobile-pt-20">6. Outsider Applications</h2>
        ...
        <h2 class="pb-2 pt-col-2 pt-sm-3 pt-md-4 pt-lg-5 pt-xl-5 mobile-pt-20">7. Client Generated Content</h2>
        ...
        <h2 class="pb-2 pt-col-2 pt-sm-3 pt-md-4 pt-lg-5 pt-xl-5 mobile-pt-20">8. Rights You Grant Us</h2>
